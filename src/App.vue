<template>
  <div v-cloak id="app">
      ...
      <template slot="body">
        <div class="alert alert-danger">
          ...
          <ul class="d-flex flex-column">
            <li
              class="lin"
              v-if="this.$store.state.okConnection.okuser === 'false'"
            >
              Vérifiez et corriger votre email !
            </li>
            <li
              class="lin"
              v-if="this.$store.state.okConnection.okregmail === 'false'"
            >
              Vérifiez et corriger votre email !
            </li>
            <li
              class="lin"
              v-if="this.$store.state.okConnection.notok === 'true'"
            >
              Email ou Mot de passe incorrect !
            </li>
            <li
              class="lin"
              v-if="this.$store.state.okConnection.okregpwd === 'false'"
            >
            ...
            <li
              class="lin"
              v-if="this.$store.state.okConnection.okpwd === 'false'"
            >
              Mot de passe invalide !
            </li>
            ...
            <li
              class="lin"
              v-if="this.$store.state.okConnection.okpwd === 'short'"
            >
              Mot de passe trop court !
            </li>
            <li
              class="lin"
              v-if="this.$store.state.okConnection.okregpwd === 'short'"
            >
              Mot de passe trop court !
            </li>
            <li
              class="lin"
              v-if="this.$store.state.okConnection.okregpwd2 === 'false'"
            >
              Confirmation mot de passe invalide !
            </li>
            <li
              class="lin"
              v-if="this.$store.state.okConnection.okregpwd2 === 'short'"
            >
    ...
    >
      <template slot="body">
        <div class="alert alert-success text-center">
          Nous avons reçu votre signalement, merci de nous aider à améliorer nos
          services &#10003;
        </div>
      </template>
    </notifications>
    ...
    >
      <template slot="body">
        <div class="alert alert-danger text-center">
          Aucun compte n'existe sous cet email, vous pouvez créer un compte sous
          cet email si vous le souhaitez.
        </div>
      </template>
    </notifications>
