    ...
    export default {
        ...
        methods: {
         ...
         checkField(){
            ...
            if(this.newpwd!=='' && this.conf_newpwd!=='' && this.conf_newpwd.length>=8 && this.newpwd.length>=8 && (this.newpwd!==this.conf_newpwd))
                this.pwd_unmatch=true
            else
                this.pwd_unmatch=false
            ...
            if(this.pwdInvalid ==false && this.pwdCourt==false && this.newpwdInvalid==false && this.newpwdCourt==false && this.con_pwdCourt==false  && this.con_pwdInvalid==false && !this.pwd_unmatch)
                return true
            return false
         }
        }
